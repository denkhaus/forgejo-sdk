...
func (c *Client) ListForks(user, repo string, opt ListForksOptions) ([]*models.Repository, *Response, error) {
	if err := escapeValidatePathSegments(&user, &repo); err != nil {
		return nil, nil, err
	}
	opt.setDefaults()
	forks := make([]*models.Repository, opt.PageSize)
