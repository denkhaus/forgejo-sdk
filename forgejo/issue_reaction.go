...
func (c *Client) GetIssueReactions(owner, repo string, index int64) ([]*models.Reaction, *Response, error) {
	if err := escapeValidatePathSegments(&owner, &repo); err != nil {
		return nil, nil, err
	}
	reactions := make([]*models.Reaction, 0, 10)
...
func (c *Client) GetIssueCommentReactions(owner, repo string, commentID int64) ([]*models.Reaction, *Response, error) {
	if err := escapeValidatePathSegments(&owner, &repo); err != nil {
		return nil, nil, err
	}
	reactions := make([]*models.Reaction, 0, 10)
...
func (c *Client) PostIssueReaction(owner, repo string, index int64, reaction string) (*models.Reaction, *Response, error) {
	if err := escapeValidatePathSegments(&owner, &repo); err != nil {
		return nil, nil, err
	}
	reactionResponse := new(models.Reaction)
...
func (c *Client) PostIssueCommentReaction(owner, repo string, commentID int64, reaction string) (*models.Reaction, *Response, error) {
	if err := escapeValidatePathSegments(&owner, &repo); err != nil {
		return nil, nil, err
	}
	reactionResponse := new(models.Reaction)
