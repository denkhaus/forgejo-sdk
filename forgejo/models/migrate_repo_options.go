...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["git","github","gitea","gitlab","gogs","onedev","gitbucket","codebase","forgejo","pagure"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// MigrateRepoOptionsServiceForgejo captures enum value "forgejo"
	MigrateRepoOptionsServiceForgejo string = "forgejo"

	// MigrateRepoOptionsServicePagure captures enum value "pagure"
	MigrateRepoOptionsServicePagure string = "pagure"
)
