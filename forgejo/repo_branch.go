...
func (c *Client) ListRepoBranches(user, repo string, opt ListRepoBranchesOptions) ([]*models.Branch, *Response, error) {
	if err := escapeValidatePathSegments(&user, &repo); err != nil {
		return nil, nil, err
	}
	opt.setDefaults()
	branches := make([]*models.Branch, 0, opt.PageSize)
...
func (c *Client) GetRepoBranch(user, repo, branch string) (*models.Branch, *Response, error) {
...
func (c *Client) CreateBranch(owner, repo string, opt CreateBranchOption) (*models.Branch, *Response, error) {
