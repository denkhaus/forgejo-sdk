...
// ref is optional
func (c *Client) GetContents(owner, repo, ref, filepath string) (*models.ContentsResponse, *Response, error) {
	data, resp, err := c.getDirOrFileContents(owner, repo, ref, filepath)
	if err != nil {
		return nil, resp, err
	}
	cr := new(models.ContentsResponse)
...
// ref is optional
func (c *Client) ListContents(owner, repo, ref, filepath string) ([]*models.ContentsResponse, *Response, error) {
	data, resp, err := c.getDirOrFileContents(owner, repo, ref, filepath)
	if err != nil {
		return nil, resp, err
	}
	crl := make([]*models.ContentsResponse, 0)
...
func (c *Client) CreateFile(owner, repo, filepath string, opt CreateFileOptions) (*models.FileResponse, *Response, error) {
	var err error
...
func (c *Client) UpdateFile(owner, repo, filepath string, opt UpdateFileOptions) (*models.FileResponse, *Response, error) {
	var err error
	if opt.BranchName, err = c.setDefaultBranchForOldVersions(owner, repo, opt.BranchName); err != nil {
		return nil, nil, err
	}
